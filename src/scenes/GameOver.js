...
export default class GameOver extends Phaser.Scene {
  ...
  async create () {
    ...
    const {gameWidth, gameHeight, playerName, playerScore} = gameDefaults;
    this.add.text(gameWidth/2, gameHeight/2 - 100, 'Game Over', { fontSize: '32px', fill: 'red' }).setOrigin(0.5, 0.5);
    this.add.text(gameWidth/2, gameHeight/2, 'LeaderBoard', { fontSize: '32px', fill: 'white' }).setOrigin(0.5, 0.5);
